        ...
        <div class="container-fluid">
          <nav class="navbar navbar-expand-lg custom_nav-container">
            ...
            <div class="collapse navbar-collapse ml-auto" id="navbarSupportedContent">
              <ul class="navbar-nav  ">
                <li class="nav-item ">
                  <a class="nav-link" href="index.html">{{ __('messages.home')}} <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="about.html"> {{ __('messages.about')}}</a>
                </li> 
                <li class="nav-item">
                  <a class="nav-link" href="service.html"> {{ __('messages.services')}} </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="guard.html"> {{ __('messages.guards')}} </a>
                </li>
